  ...
  <div class="usage-issues">
    <div class="page-header">
      ...
      <div class="header-actions">
        ...
        <el-button type="success" @click="handleAskQuestionsDialog">
      ...
      >
        <div class="question-form">
          ...
          <div class="dialog-footer">
            <el-button @click="askQuestionsDialog = false">取消</el-button>
            <el-button type="primary" @click="handleAskQuestions">
